...
- Your tenant ID is: `rdocker-20260307-210856_LND-004_BRW-025`
- All API calls must include the header: `X-Tenant-Id: rdocker-20260307-210856_LND-004_BRW-025`
...
curl -s -X POST http://localhost:3000/v1/entities \
  ...
  -H "X-Tenant-Id: rdocker-20260307-210856_LND-004_BRW-025" \
...
# List deals
curl -s http://localhost:3000/v1/deals -H "X-Tenant-Id: rdocker-20260307-210856_LND-004_BRW-025" | jq
```
